...
public class Favourite extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cl_similar = (ConstraintLayout) findViewById(R.id.cl_fav);
        rv_similar = (RecyclerView) findViewById(R.id.rv_wishlist);
        ...
        api.fetchWishlist(requestBody).enqueue(new Callback<userResponse>() {
            @Override
